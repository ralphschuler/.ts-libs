...
import { InputType, InputTypes } from "./inputTypes.js";
import {
  Parser,
  ParserState,
  Err,
...
export function withData<T, E, D>(
...
export function pipeParsers<A, B, C, D>([p1, p2, p3, p4]: [
  Parser<A>,
  Parser<B>,
  Parser<C>,
  Parser<D>,
]): Parser<D>;
export function pipeParsers<A, B, C, D, E>([p1, p2, p3, p4, p5]: [
  Parser<A>,
  Parser<B>,
  Parser<C>,
  Parser<D>,
...
export function pipeParsers<A, B, C, D, E, F>([p1, p2, p3, p4, p5, p6]: [
  Parser<A>,
  Parser<B>,
  Parser<C>,
  Parser<D>,
...
export function pipeParsers<A, B, C, D, E, F, G>([p1, p2, p3, p4, p5, p6, p7]: [
  Parser<A>,
  Parser<B>,
  Parser<C>,
  Parser<D>,
...
export function pipeParsers<A, B, C, D, E, F, G, H>([
  p1,
  p2,
  p3,
  p4,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I>([
  p1,
  p2,
  p3,
  p4,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I, J>([
  p1,
  p2,
  p3,
  p4,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I, J, K>([
  p1,
  p2,
  p3,
  p4,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I, J, K, L>([
  p1,
  p2,
  p3,
  p4,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I, J, K, L, M>([
  p1,
  p2,
  p3,
  p4,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I, J, K, L, M, N>([
  p1,
  p2,
  p3,
  p4,
...
export function pipeParsers<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>([
  p1,
  p2,
  p3,
  p4,
...
export function composeParsers<A, B>([p1, p2]: [
  Parser<A>,
  Parser<B>,
]): Parser<A>;
...
export function composeParsers<A, B, C, D>([p1, p2, p3, p4]: [
  Parser<A>,
  Parser<B>,
  Parser<C>,
  Parser<D>,
]): Parser<A>;
export function composeParsers<A, B, C, D, E>([p1, p2, p3, p4, p5]: [
  Parser<A>,
  Parser<B>,
  Parser<C>,
  Parser<D>,
...
export function composeParsers<A, B, C, D, E, F>([p1, p2, p3, p4, p5, p6]: [
  Parser<A>,
  Parser<B>,
  Parser<C>,
  Parser<D>,
...
export function composeParsers<A, B, C, D, E, F, G>([
  p1,
  p2,
  p3,
  p4,
...
export function composeParsers<A, B, C, D, E, F, G, H>([
  p1,
  p2,
  p3,
  p4,
...
export function composeParsers<A, B, C, D, E, F, G, H, I>([
  p1,
  p2,
  p3,
  p4,
...
export function composeParsers<A, B, C, D, E, F, G, H, I, J>([
  p1,
  p2,
  p3,
  p4,
...
export function composeParsers<A, B, C, D, E, F, G, H, I, J, K>([
  p1,
  p2,
  p3,
  p4,
...
export function composeParsers<A, B, C, D, E, F, G, H, I, J, K, L>([
  p1,
  p2,
  p3,
  p4,
...
export function composeParsers<A, B, C, D, E, F, G, H, I, J, K, L, M>([
  p1,
  p2,
  p3,
  p4,
...
export function composeParsers<A, B, C, D, E, F, G, H, I, J, K, L, M, N>([
  p1,
  p2,
  p3,
  p4,
...
export function composeParsers<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>([
  p1,
  p2,
  p3,
  p4,
...
export function parse<T, E, D>(
  parser: Parser<T, E, D>,
): (target: InputType) => ResultType<T, E, D> {
...
export function decide<T, T2, E2, D2>(
...
export function exactly<T, N extends 3>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T]>;
export function exactly<T, N extends 4>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T]>;
export function exactly<T, N extends 5>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T]>;
export function exactly<T, N extends 6>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T]>;
export function exactly<T, N extends 7>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T, T]>;
export function exactly<T, N extends 8>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T, T, T]>;
export function exactly<T, N extends 9>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T, T, T, T]>;
export function exactly<T, N extends 10>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T, T, T, T, T]>;
export function exactly<T, N extends 11>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T, T, T, T, T, T]>;
export function exactly<T, N extends 12>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T, T, T, T, T, T, T]>;
export function exactly<T, N extends 13>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T, T, T, T, T, T, T, T]>;
export function exactly<T, N extends 14>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T, T, T, T, T, T, T, T, T]>;
export function exactly<T, N extends 15>(
  n: N,
): (p: Parser<T>) => Parser<[T, T, T, T, T, T, T, T, T, T, T, T, T, T, T]>;
...
export function errorMapTo<E, E2, D>(
...
export function namedSequenceOf(
  pairedParsers: Array<[string, Parser<any>]>,
): Parser<any[]> {
...
export function sequenceOf<A, B>([p1, p2]: [Parser<A>, Parser<B>]): Parser<
  [A, B]
>;
...
export function sequenceOf<A, B, C, D, E, F, G, H>([
  p1,
  p2,
  p3,
  p4,
...
export function sequenceOf<A, B, C, D, E, F, G, H, I>([
  p1,
  p2,
  p3,
  p4,
...
export function choice<A, B, C>([p1, p2, p3]: [
  Parser<A>,
  Parser<B>,
  Parser<C>,
]): Parser<A | B | C>;
...
export function choice<A, B, C, D, E, F, G, H>([
  p1,
  p2,
  p3,
  p4,
...
export function choice<A, B, C, D, E, F, G, H, I>([
  p1,
  p2,
  p3,
  p4,
...
export function possibly<T, E, D>(
  parser: Parser<T, E, D>,
): Parser<T | null, E, D> {
...
export function recursiveParser<T, E, D>(
